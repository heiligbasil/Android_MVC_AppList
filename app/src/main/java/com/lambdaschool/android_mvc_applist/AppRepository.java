...
public class AppRepository {
    ...
    public static ArrayList<AppListing> getAppListings() {
        ...
        ArrayList<AppListing> listOfMockData = new ArrayList<>();

        for (String lineChunk : appStrings) {
            String[] chunkComponents = lineChunk.split(",");

            AppListing organizedComponents = new AppListing();
            try {
            ...
            organizedComponents.setDomainName(chunkComponents[3]);
            organizedComponents.setContactEmail(chunkComponents[4]);
            organizedComponents.setImageUrl(chunkComponents[5]);

            listOfMockData.add(organizedComponents);
        }

        listOfMockData.remove(0);

        return listOfMockData;
    }
